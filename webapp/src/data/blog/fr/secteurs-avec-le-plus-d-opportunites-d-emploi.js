export default {
  ...
  category: 'carriera',
  metaTitle: 'Les secteurs avec le plus d\'opportunités d\'emploi aujourd\'hui',
  metaDescription: 'Découvrez quels sont les secteurs offrant le plus d\'opportunités professionnelles, les compétences les plus demandées et les tendances qui transforment le marché du travail.',
  ...
  sections: [
    ...
    {
      heading: 'Pourquoi le secteur croît',
      blocks: [
    ...
    {
      heading: 'Développeurs logiciels',
      blocks: [
    ...
    {
      heading: 'Cloud et infrastructures',
      blocks: [
    ...
    {
      heading: 'Chefs de chantier',
      blocks: [
        'Un rôle clé dans la gestion des projets.',
      ],
    },
    {
      heading: 'Professionnels spécialisés',
      blocks: [
    ...
    {
      heading: 'Pourquoi le secteur est intéressant',
      blocks: [
    ...
    {
      heading: 'La formation comme pont',
      blocks: [
    ...
    {
      heading: 'Les professions avec les meilleures perspectives pour les prochaines années',
      blocks: [
    ...
    {
      heading: 'Énergie et durabilité',
      blocks: [
        'Les entreprises investissent de plus en plus dans ces domaines.',
      ],
    },
    {
      heading: 'Professions techniques',
      blocks: [
        'Les compétences spécialisées resteront difficiles à trouver.',
      ],
    },
    {
      heading: 'Services à la personne',
      blocks: [
        'L\'évolution démographique soutiendra la demande également dans les années à venir.',
      ],
    },
    { related: { question: 'Vous avez trouvé le bon secteur ? Découvrez comment organiser votre recherche.', slug: 'come-trovare-lavoro-guida-pratica' } },
    {
      heading: 'Conclusion',
      blocks: [
  ...
  checklist: [
    'Marché : Je connais les secteurs en croissance',
    'Marché : Je connais les professions les plus demandées',
    'Compétences : J\'ai identifié mes points forts',
    'Compétences : Je développe les compétences demandées',
    'Formation : J\'ai un plan de mise à jour professionnelle',
    'Stratégie : Je surveille l\'évolution du marché',
    'Stratégie : J\'évalue de nouvelles opportunités de croissance',
  ],
  faq: [
    { q: 'Quels sont aujourd\'hui les secteurs avec le plus d\'opportunités ?', a: 'La santé, la technologie, les professions techniques, la construction, la logistique et les services continuent de montrer une demande significative.' },
    { q: 'Quelles compétences sont les plus demandées ?', a: 'Les compétences numériques, linguistiques, organisationnelles et relationnelles.' },
    { q: 'Est-il possible de changer de secteur sans expérience ?', a: 'Oui. Les compétences transférables et la formation peuvent faciliter la transition.' },
    { q: 'Les professions techniques ont-elles encore des perspectives ?', a: 'Absolument oui. De nombreuses entreprises ont du mal à trouver du personnel qualifié.' },
    { q: 'La technologie va-t-elle remplacer de nombreuses professions ?', a: 'Certaines activités seront automatisées, mais la demande de compétences liées à la gestion et au développement des technologies va croître.' },
  ],
  signature: 'cand',
};
