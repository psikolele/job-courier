export default {
  ...
  category: 'carriera',
  metaTitle: 'Rédiger un CV qui obtient des entretiens : guide pratique',
  metaDescription: 'Découvrez comment créer un CV efficace, valoriser vos compétences et augmenter vos chances d\'obtenir un entretien. Conseils pratiques, erreurs à éviter et exemples concrets.',
  ...
  sections: [
    ...
    {
      heading: 'Formule simple',
      blocks: [
        'Profession + expérience + spécialisation + point fort.',
      ],
    },
    {
      heading: 'Exemple administratif',
      blocks: [
    ...
    {
      heading: 'Cinq exemples pratiques d\'amélioration',
      blocks: [
    ...
    { related: { question: 'Vous avez un bon CV mais les réponses tardent ? Découvrez pourquoi.', slug: 'perche-non-ricevi-risposte-alle-candidature' } },
    {
      heading: 'Conclusion',
      blocks: [
  ...
  checklist: [
    'Contenu : Profil professionnel à jour',
    'Contenu : Expériences claires',
    'Contenu : Résultats mis en avant',
    'Contenu : Compétences pertinentes',
    'Forme : Aucune erreur grammaticale',
    'Forme : Mise en page soignée',
    'Forme : Informations cohérentes',
    'Personnalisation : CV adapté au poste',
    'Personnalisation : Compétences requises mises en avant',
    'Personnalisation : Terminologie cohérente avec l\'annonce',
    'Présence en ligne : Profil LinkedIn à jour',
    'Présence en ligne : Informations cohérentes entre CV et LinkedIn',
  ],
  faq: [
    { q: 'Quelle doit être la longueur d\'un CV ?', a: 'Dans la plupart des cas, une ou deux pages suffisent.' },
    { q: 'Faut-il insérer une photo ?', a: 'Cela dépend du contexte et des préférences personnelles. Si vous en insérez une, elle doit être professionnelle et récente.' },
    { q: 'Faut-il personnaliser le CV ?', a: 'Oui. Même de petites modifications peuvent augmenter significativement la pertinence de la candidature.' },
    { q: 'Les compétences linguistiques sont-elles importantes ?', a: 'Oui. Dans de nombreux secteurs, elles représentent un élément distinctif.' },
    { q: 'Faut-il inclure toutes les expériences professionnelles ?', a: 'Non. Concentrez-vous sur les expériences les plus pertinentes et récentes.' },
    { q: 'LinkedIn peut-il remplacer le CV ?', a: 'Non. Les deux outils sont complémentaires.' },
  ],
  signature: 'cand',
};
