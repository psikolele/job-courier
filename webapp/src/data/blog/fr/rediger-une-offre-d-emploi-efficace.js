export default {
  ...
  category: 'recruiting',
  metaTitle: 'Comment rédiger une offre d\'emploi efficace : guide pour les entreprises',
  metaDescription: 'Découvrez comment créer des offres d\'emploi qui attirent des candidats qualifiés, améliorent la qualité des candidatures et réduisent les délais de recrutement.',
  ...
  sections: [
    ...
    {
      heading: 'Pourquoi une bonne offre est fondamentale',
      blocks: [
    ...
    {
      heading: 'Le temps de recrutement',
      blocks: [
    ...
    {
      heading: 'L\'erreur que commettent de nombreuses entreprises',
      blocks: [
    ...
    {
      heading: 'Les six sections d\'une offre efficace',
      blocks: [
    ...
    {
      heading: 'Distinguez entre essentiel et souhaitable',
      blocks: [
        'Une bonne pratique consiste à séparer :',
      ],
    },
    {
      heading: 'Exigences indispensables',
      blocks: [
        'Les compétences sans lesquelles le poste ne peut pas être exercé.',
      ],
    },
    {
      heading: 'Exigences préférentielles',
      blocks: [
    ...
    {
      heading: 'Croissance professionnelle',
      blocks: [
    ...
    { related: { question: 'Annonce publiée mais peu de profils adaptés ? Découvrez les causes.', slug: 'perche-non-ricevi-candidature-qualificate' } },
    {
      heading: 'Conclusion',
      blocks: [
  ...
  checklist: [
    ...
    'Poste : Responsabilités bien définies',
    'Poste : Langage concret',
    'Exigences : Uniquement celles réellement nécessaires',
    'Exigences : Distinction entre indispensables et préférentielles',
    'Avantages : Opportunités de croissance',
    'Avantages : Éléments distinctifs de l\'entreprise',
    'Communication : Texte simple',
    'Communication : Lecture fluide',
    'Communication : Aucune information ambiguë',
  ],
  faq: [
    { q: 'Quelle devrait être la longueur d\'une offre d\'emploi ?', a: 'Il n\'existe pas de longueur idéale, mais elle devrait contenir toutes les informations nécessaires sans devenir confuse.' },
    { q: 'Est-il utile d\'indiquer le salaire ?', a: 'Quand c\'est possible, la transparence contribue à augmenter la confiance des candidats.' },
    { q: 'Combien d\'exigences devrais-je inclure ?', a: 'Seulement celles réellement indispensables. Un nombre excessif peut réduire le nombre de candidatures.' },
    { q: 'Les avantages sont-ils vraiment importants ?', a: 'Oui. De plus en plus de candidats évaluent attentivement ce que l\'entreprise offre au-delà de la rémunération.' },
    { q: 'Comment améliorer la qualité des candidatures ?', a: 'Grâce à des offres claires, réalistes et bien structurées.' },
    { q: 'Vaut-il la peine de mettre à jour des offres existantes ?', a: 'Absolument oui. De petites améliorations peuvent produire des résultats très différents.' },
  ],
  signature: 'az',
};
