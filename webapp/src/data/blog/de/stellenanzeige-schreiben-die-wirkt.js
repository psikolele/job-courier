export default {
  ...
  category: 'recruiting',
  metaTitle: 'Wirksame Stellenanzeige schreiben: Praxisleitfaden für Unternehmen',
  metaDescription: 'Erfahren Sie, wie Sie Stellenanzeigen erstellen, die qualifizierte Kandidaten anziehen, die Qualität der Bewerbungen verbessern und die Auswahlzeit verkürzen.',
  ...
  sections: [
    ...
    {
      heading: 'Warum eine gute Stellenanzeige grundlegend ist',
      blocks: [
    ...
    {
      heading: 'Der Fehler, den viele Unternehmen machen',
      blocks: [
    ...
    {
      heading: 'Die sechs Abschnitte einer wirksamen Stellenanzeige',
      blocks: [
    ...
    {
      heading: 'Unterscheiden Sie zwischen unverzichtbar und wünschenswert',
      blocks: [
        'Eine gute Praxis besteht darin, zu trennen:',
      ],
    },
    {
      heading: 'Unverzichtbare Anforderungen',
      blocks: [
        'Die Kompetenzen, ohne die die Rolle nicht ausgeübt werden kann.',
      ],
    },
    {
      heading: 'Bevorzugte Anforderungen',
      blocks: [
    ...
    {
      heading: 'Zu lange Stellenanzeigen',
      blocks: [
    ...
    { related: { question: 'Stellenanzeige veröffentlicht, aber wenige passende Profile? Erfahren Sie die Ursachen.', slug: 'perche-non-ricevi-candidature-qualificate' } },
    {
      heading: 'Fazit',
      blocks: [
  ...
  checklist: [
    ...
    'Titel: Spezifisch',
    'Titel: Verständlich',
    'Rolle: Verantwortlichkeiten gut definiert',
    'Rolle: Konkrete Sprache',
    'Anforderungen: Nur die wirklich notwendigen',
    'Anforderungen: Unterscheidung zwischen unverzichtbar und bevorzugt',
    'Benefits: Wachstumsmöglichkeiten',
    'Benefits: Unterscheidungsmerkmale des Unternehmens',
    'Kommunikation: Einfacher Text',
    'Kommunikation: Flüssige Lesbarkeit',
    'Kommunikation: Keine mehrdeutigen Informationen',
  ],
  faq: [
    { q: 'Wie lang sollte eine Stellenanzeige sein?', a: 'Es gibt keine ideale Länge, aber sie sollte alle notwendigen Informationen enthalten, ohne unstrukturiert zu werden.' },
    { q: 'Ist es sinnvoll, das Gehalt anzugeben?', a: 'Wenn möglich, trägt Transparenz dazu bei, das Vertrauen der Kandidaten zu erhöhen.' },
    { q: 'Wie viele Anforderungen sollte ich angeben?', a: 'Nur die wirklich unverzichtbaren. Eine zu hohe Anzahl kann die Anzahl der Bewerbungen verringern.' },
    { q: 'Sind Benefits wirklich wichtig?', a: 'Ja. Immer mehr Kandidaten bewerten sorgfältig, was das Unternehmen über die Vergütung hinaus bietet.' },
    { q: 'Wie kann man die Qualität der Bewerbungen verbessern?', a: 'Durch klare, realistische und gut strukturierte Stellenanzeigen.' },
    { q: 'Lohnt es sich, bestehende Stellenanzeigen zu aktualisieren?', a: 'Absolut ja. Kleine Verbesserungen können sehr unterschiedliche Ergebnisse hervorbringen.' },
  ],
  signature: 'az',
};
