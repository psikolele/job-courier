export default {
  ...
  category: 'carriera',
  metaTitle: 'Branchen mit den meisten Jobmöglichkeiten heute',
  metaDescription: 'Erfahren Sie, welche Branchen heute die meisten beruflichen Möglichkeiten bieten, welche Kompetenzen am stärksten gefragt sind und welche Trends den Arbeitsmarkt verändern.',
  ...
  sections: [
    ...
    {
      heading: 'Fachangestellte Gesundheit (FaGe)',
      blocks: [
    ...
    {
      heading: 'Warum die Branche wächst',
      blocks: [
    ...
    {
      heading: 'Cloud und Infrastruktur',
      blocks: [
    ...
    {
      heading: 'Spezialisierte Fachkräfte',
      blocks: [
    ...
    {
      heading: 'Payroll und Personaladministration',
      blocks: [
    ...
    {
      heading: 'Weiterbildung als Brücke',
      blocks: [
    ...
    {
      heading: 'Die Berufe mit den besten Aussichten in den nächsten Jahren',
      blocks: [
    ...
    {
      heading: 'Energie und Nachhaltigkeit',
      blocks: [
        'Unternehmen investieren zunehmend in diese Bereiche.',
      ],
    },
    {
      heading: 'Technische Berufe',
      blocks: [
        'Spezialisierte Kompetenzen bleiben weiterhin schwer zu finden.',
      ],
    },
    {
      heading: 'Personennahe Dienstleistungen',
      blocks: [
        'Die demografische Entwicklung wird die Nachfrage auch in den nächsten Jahren stützen.',
      ],
    },
    { related: { question: 'Haben Sie die richtige Branche gefunden? Erfahren Sie, wie Sie die Suche organisieren.', slug: 'come-trovare-lavoro-guida-pratica' } },
    {
      heading: 'Fazit',
      blocks: [
  ...
  checklist: [
    'Markt: Ich kenne die wachsenden Branchen',
    'Markt: Ich kenne die gefragtesten Berufe',
    'Kompetenzen: Ich habe meine Stärken identifiziert',
    'Kompetenzen: Ich entwickle gefragte Kompetenzen',
    'Weiterbildung: Ich habe einen Plan zur beruflichen Weiterentwicklung',
    'Strategie: Ich beobachte die Marktentwicklung',
    'Strategie: Ich prüfe neue Entwicklungsmöglichkeiten',
  ],
  faq: [
    { q: 'Welche Branchen bieten heute die meisten Möglichkeiten?', a: 'Gesundheitswesen, Technologie, technische Berufe, Bauwesen, Logistik und Dienstleistungen zeigen weiterhin eine deutliche Nachfrage.' },
    { q: 'Welche Kompetenzen sind am stärksten gefragt?', a: 'Digitale, sprachliche, organisatorische und zwischenmenschliche Kompetenzen.' },
    { q: 'Ist ein Branchenwechsel ohne Erfahrung möglich?', a: 'Ja. Übertragbare Kompetenzen und Weiterbildung können den Übergang erleichtern.' },
    { q: 'Haben technische Berufe noch Zukunftsperspektiven?', a: 'Absolut. Viele Unternehmen haben Mühe, qualifiziertes Personal zu finden.' },
    { q: 'Wird die Technologie viele Berufe ersetzen?', a: 'Manche Tätigkeiten werden automatisiert, aber die Nachfrage nach Kompetenzen im Bereich Steuerung und Entwicklung von Technologien wird wachsen.' },
  ],
  signature: 'cand',
};
