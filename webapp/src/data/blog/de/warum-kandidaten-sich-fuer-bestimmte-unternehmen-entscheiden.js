export default {
  ...
  category: 'recruiting',
  metaTitle: 'Warum Kandidaten sich für bestimmte Unternehmen entscheiden',
  metaDescription: 'Warum ziehen manche Unternehmen bessere Kandidaten an als andere? Erfahren Sie, welche Faktoren die Wahl der Fachkräfte beeinflussen und wie Sie attraktiver werden.',
  ...
  sections: [
    ...
    { cta: { question: 'Möchten Sie, dass Kandidaten sich für Ihr Unternehmen entscheiden? Lassen Sie sich finden.', action: 'Stellenanzeige aufgeben', to: '/soluzioni-e-tariffe' } },
    {
    ...
    {
      heading: 'Der Wettbewerb betrifft auch die Unternehmen',
      blocks: [
    ...
    {
      heading: 'Der Irrglaube vieler KMU',
      blocks: [
    ...
    {
      heading: 'Menschen bewerten das Gesamtpaket',
      blocks: [
    ...
    {
      heading: 'Gefühle spielen eine Rolle',
      blocks: [
    ...
    {
      heading: 'Die sieben Dinge, die Kandidaten wirklich bewerten',
      blocks: [
    ...
    {
      heading: '4. Berufliche Entwicklung',
      blocks: [
    ...
    {
      heading: 'Ein oft unterschätzter Vorteil von KMU',
      blocks: [
    ...
    {
      heading: 'In KMU kann das ein enormer Vorteil sein',
      blocks: [
    ...
    {
      heading: 'Was nicht kommuniziert wird, erzeugt keinen Wert',
      blocks: [
        'Menschen können nur bewerten, was sie wahrnehmen können.',
      ],
    },
    {
      heading: 'Was sieht ein Kandidat, wenn er nach Informationen sucht?',
      blocks: [
    ...
    {
      heading: 'Die Menschen',
      blocks: [
        'Auch Mitarbeitende, Kunden und Lieferanten tragen dazu bei, den Ruf der Organisation zu prägen.',
      ],
    },
    {
      heading: 'Unternehmen, die bessere Kandidaten anziehen, machen einige Dinge sehr gut',
      blocks: [
  ...
  checklist: [
    'Unternehmen: Ich kenne meine Stärken',
    'Unternehmen: Ich weiss, was mich unterscheidet',
    'Kommunikation: Die Website ist aktuell',
    'Kommunikation: Die Stellenanzeigen erzählen die Möglichkeit',
    'Recruiting: Ich antworte schnell',
    'Recruiting: Ich biete den Kandidaten eine positive Erfahrung',
    'Kultur: Was ich kommuniziere, entspricht der Realität',
  ],
  faq: [
    { q: 'Schauen sich Kandidaten wirklich die Unternehmenswebsite an?', a: 'Ja. Immer mehr Menschen sammeln Informationen, bevor sie sich bewerben.' },
    { q: 'Ist der Lohn der wichtigste Faktor?', a: 'Er ist wichtig, aber selten das einzige Element, das eine Entscheidung beeinflusst.' },
    { q: 'Kann ein KMU mit grossen Unternehmen konkurrieren?', a: 'Absolut. Oft besitzt es Vorteile, die grosse Organisationen nicht bieten können.' },
    { q: 'Muss man viel Geld investieren?', a: 'Nicht unbedingt. Viele Verbesserungen betreffen Kommunikation, Konsistenz und die Erfahrung der Kandidaten.' },
    { q: 'Ist es wichtig, nicht ausgewählten Kandidaten zu antworten?', a: 'Ja. Jede Interaktion trägt zum Ruf des Unternehmens bei.' },
  ],
  signature: 'az',
};
