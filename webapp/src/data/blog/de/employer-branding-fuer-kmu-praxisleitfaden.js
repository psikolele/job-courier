export default {
  ...
  category: 'recruiting',
  metaTitle: 'Employer Branding für KMU: Praxisleitfaden für bessere Bewerbungen',
  metaDescription: 'Erfahren Sie, wie Sie ein wirksames Employer Branding aufbauen, die Attraktivität Ihres Unternehmens steigern und qualifiziertere Bewerbungen erhalten.',
  ...
  sections: [
    ...
    {
      heading: 'Eine nützliche Formel',
      blocks: [
        'Man kann sich Employer Branding als die Summe von drei Elementen vorstellen:',
      ],
    },
    { cta: { question: 'Beginnen Sie mit dem Aufbau Ihres Employer Brandings, indem Sie Ihre Stellen veröffentlichen.', action: 'Stellenanzeige aufgeben', to: '/soluzioni-e-tariffe' } },
    {
      heading: 'Reputation',
      blocks: [
    ...
    {
      heading: 'Die Reputation lässt sich nicht vollständig kontrollieren',
      blocks: [
    ...
    {
      heading: 'Nutzen Sie konkrete Beispiele',
      blocks: [
    ...
    {
      heading: 'Erfahrungsberichte schaffen Glaubwürdigkeit',
      blocks: [
    ...
    {
      heading: 'Jeder Kontakt hinterlässt einen Eindruck',
      blocks: [
  ...
  checklist: [
    'Reputation: Ich weiss, wie mein Unternehmen wahrgenommen wird',
    'Kultur: Die kommunizierten Werte entsprechen der Realität',
    'Führung: Führungskräfte und Verantwortliche repräsentieren die Organisation positiv',
    'Candidate Experience: Die Prozesse sind klar und respektvoll',
    'Kommunikation: Ich erzähle, was das Unternehmen einzigartig macht',
    'Kohärenz: Website, Stellenanzeigen und Vorstellungsgespräche vermitteln dieselben Botschaften',
  ],
  faq: [
    { q: 'Ist Employer Branding nur für grosse Unternehmen nützlich?', a: 'Nein. Im Gegenteil, KMU verfügen oft über sehr geschätzte Eigenschaften, die es wert sind, hervorgehoben zu werden.' },
    { q: 'Braucht es ein hohes Budget?', a: 'Nicht unbedingt. Viele Massnahmen erfordern vor allem Aufmerksamkeit, Kohärenz und Kontinuität.' },
    { q: 'Wie lange dauert es, bis man Ergebnisse sieht?', a: 'Employer Branding ist eine mittel- bis langfristige Investition, aber einige Verbesserungen können bereits in den ersten Monaten Wirkung zeigen.' },
    { q: 'Funktionieren Erfahrungsberichte wirklich?', a: 'Ja. Die Menschen vertrauen tendenziell mehr den Erfahrungen, die von anderen Mitarbeitenden erzählt werden.' },
    { q: 'Wie kann ich erkennen, ob unser Employer Branding wirksam ist?', a: 'Indem Sie Indikatoren beobachten wie: Qualität der Bewerbungen; Einstellungsdauer; Bindung der Mitarbeitenden; Feedback der Kandidaten.' },
  ],
  signature: 'az',
};
