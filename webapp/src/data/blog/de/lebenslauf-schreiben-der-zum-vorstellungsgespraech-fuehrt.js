export default {
  ...
  category: 'carriera',
  metaTitle: 'Lebenslauf schreiben, der zum Vorstellungsgespräch führt',
  metaDescription: 'Erfahren Sie, wie Sie einen wirksamen Lebenslauf erstellen, Ihre Kompetenzen hervorheben und die Chancen auf ein Vorstellungsgespräch erhöhen. Praktische Tipps, zu vermeidende Fehler und konkrete Beispiele.',
  ...
  sections: [
    ...
    {
      heading: 'Einfache Formel',
      blocks: [
        'Beruf + Erfahrung + Spezialisierung + Stärke.',
      ],
    },
    {
      heading: 'Beispiel Verwaltung',
      blocks: [
    ...
    {
      heading: 'Fünf praktische Verbesserungsbeispiele',
      blocks: [
    ...
    { related: { question: 'Sie haben einen guten Lebenslauf, aber es kommen keine Antworten? Erfahren Sie warum.', slug: 'perche-non-ricevi-risposte-alle-candidature' } },
    {
      heading: 'Fazit',
      blocks: [
  ...
  checklist: [
    'Inhalt: Berufsprofil aktualisiert',
    'Inhalt: Erfahrungen klar',
    'Inhalt: Ergebnisse hervorgehoben',
    'Inhalt: Relevante Kompetenzen',
    'Form: Keine Grammatikfehler',
    'Form: Geordnetes Layout',
    'Form: Konsistente Informationen',
    'Personalisierung: Lebenslauf an die Position angepasst',
    'Personalisierung: Geforderte Kompetenzen hervorgehoben',
    'Personalisierung: Mit der Stellenanzeige übereinstimmende Terminologie',
    'Online-Präsenz: LinkedIn-Profil aktualisiert',
    'Online-Präsenz: Konsistente Informationen zwischen Lebenslauf und LinkedIn',
  ],
  faq: [
    { q: 'Wie lang muss ein Lebenslauf sein?', a: 'In den meisten Fällen genügen ein bis zwei Seiten.' },
    { q: 'Muss ich ein Foto einfügen?', a: 'Das hängt vom Kontext und den persönlichen Präferenzen ab. Wenn eingefügt, sollte es professionell und aktuell sein.' },
    { q: 'Muss der Lebenslauf personalisiert werden?', a: 'Ja. Auch kleine Anpassungen können die Relevanz der Bewerbung erheblich erhöhen.' },
    { q: 'Sind Sprachkenntnisse wichtig?', a: 'Ja. In vielen Branchen stellen sie ein unterscheidendes Element dar.' },
    { q: 'Muss ich alle Berufserfahrungen angeben?', a: 'Nein. Konzentrieren Sie sich auf die relevantesten und aktuellsten Erfahrungen.' },
    { q: 'Kann LinkedIn den Lebenslauf ersetzen?', a: 'Nein. Die beiden Instrumente ergänzen sich.' },
  ],
  signature: 'cand',
};
