export default {
  ...
  category: 'carriera',
  metaTitle: 'Come scrivere un CV che ottiene colloqui: guida pratica per candidati',
  metaDescription: 'Scopri come creare un curriculum efficace, valorizzare le tue competenze e aumentare le probabilità di ottenere un colloquio. Consigli pratici, errori da evitare ed esempi concreti.',
  ...
  sections: [
    ...
    {
      heading: 'Esperienze professionali',
      blocks: [
    ...
    {
      heading: 'Formula semplice',
      blocks: [
        'Professione + esperienza + specializzazione + punto di forza.',
      ],
    },
    {
      heading: 'Esempio amministrativo',
      blocks: [
    ...
    {
      heading: 'Cinque esempi pratici di miglioramento',
      blocks: [
    ...
    { related: { question: 'Hai un buon CV ma le risposte non arrivano? Scopri perché.', slug: 'perche-non-ricevi-risposte-alle-candidature' } },
    {
      heading: 'Conclusione',
      blocks: [
  ...
  checklist: [
    'Contenuto: Profilo professionale aggiornato',
    'Contenuto: Esperienze chiare',
    'Contenuto: Risultati evidenziati',
    'Contenuto: Competenze rilevanti',
    'Forma: Nessun errore grammaticale',
    'Forma: Layout ordinato',
    'Forma: Informazioni coerenti',
    'Personalizzazione: Curriculum adattato alla posizione',
    'Personalizzazione: Competenze richieste evidenziate',
    'Personalizzazione: Terminologia coerente con l\'annuncio',
    'Presenza online: Profilo LinkedIn aggiornato',
    'Presenza online: Informazioni coerenti tra CV e LinkedIn',
  ],
  faq: [
    { q: 'Quanto deve essere lungo un CV?', a: 'Nella maggior parte dei casi una o due pagine sono sufficienti.' },
    { q: 'Serve inserire la foto?', a: 'Dipende dal contesto e dalle preferenze personali. Se inserita, dovrebbe essere professionale e recente.' },
    { q: 'È necessario personalizzare il curriculum?', a: 'Sì. Anche piccole modifiche possono aumentare significativamente la pertinenza della candidatura.' },
    { q: 'Le competenze linguistiche sono importanti?', a: 'Sì. In molti settori rappresentano un elemento distintivo.' },
    { q: 'Devo inserire tutte le esperienze professionali?', a: 'No. Concentrati sulle esperienze più rilevanti e recenti.' },
    { q: 'LinkedIn può sostituire il curriculum?', a: 'No. I due strumenti sono complementari.' },
  ],
  signature: 'cand',
};
