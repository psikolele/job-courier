export default {
  ...
  category: 'recruiting',
  metaTitle: 'Employer Branding per PMI: guida pratica per attrarre candidati migliori',
  metaDescription: 'Scopri come costruire un employer branding efficace, migliorare l\'attrattività della tua azienda e ricevere candidature più qualificate.',
  ...
  sections: [
    ...
    {
      heading: 'Una formula utile',
      blocks: [
        'Possiamo immaginare l\'employer branding come la somma di tre elementi:',
      ],
    },
    { cta: { question: 'Inizia a costruire il tuo employer branding pubblicando le tue posizioni.', action: 'Pubblica il tuo annuncio', to: '/soluzioni-e-tariffe' } },
    {
      heading: 'Reputazione',
      blocks: [
    ...
    {
      heading: 'La reputazione non si controlla completamente',
      blocks: [
    ...
    {
      heading: 'Utilizza esempi concreti',
      blocks: [
    ...
    {
      heading: 'Le testimonianze creano credibilità',
      blocks: [
    ...
    {
      heading: 'Ogni contatto lascia un\'impressione',
      blocks: [
    ...
    {
      heading: 'Social abbandonati',
      blocks: [
        'Profili inattivi da anni trasmettono un\'immagine negativa.',
      ],
    },
    {
      heading: 'Nessuna risposta ai candidati',
      blocks: [
    ...
    {
      heading: 'Pensare che l\'employer branding sia solo comunicazione',
      blocks: [
  ...
  checklist: [
    'Reputazione: Conosco come viene percepita la mia azienda',
    'Cultura: I valori comunicati corrispondono alla realtà',
    'Leadership: Manager e responsabili rappresentano positivamente l\'organizzazione',
    'Esperienza candidato: I processi sono chiari e rispettosi',
    'Comunicazione: Racconto ciò che rende unica l\'azienda',
    'Coerenza: Sito, annunci e colloqui trasmettono gli stessi messaggi',
  ],
  faq: [
    { q: 'L\'employer branding è utile solo alle grandi aziende?', a: 'No. Anzi, le PMI spesso dispongono di caratteristiche molto apprezzate che meritano di essere valorizzate.' },
    { q: 'Serve un budget elevato?', a: 'Non necessariamente. Molte azioni richiedono soprattutto attenzione, coerenza e continuità.' },
    { q: 'Quanto tempo serve per vedere risultati?', a: 'L\'employer branding è un investimento di medio-lungo periodo, ma alcuni miglioramenti possono produrre effetti già nei primi mesi.' },
    { q: 'Le testimonianze funzionano davvero?', a: 'Sì. Le persone tendono a fidarsi maggiormente delle esperienze raccontate da altri collaboratori.' },
    { q: 'Come capire se il nostro employer branding è efficace?', a: 'Osservando indicatori come: qualità delle candidature; tempo di assunzione; retention; feedback dei candidati.' },
  ],
  signature: 'az',
};
