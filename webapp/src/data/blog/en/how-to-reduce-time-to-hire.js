export default {
  ...
  category: 'recruiting',
  metaTitle: 'How to Reduce Time-to-Hire: Practical Strategies for SMEs',
  metaDescription: 'Discover how to speed up the selection process, reduce time-to-hire and improve the candidate experience.',
  ...
  sections: [
    ...
    {
      heading: 'The "perfect candidate" mistake',
      blocks: [
    ...
    {
      heading: 'How to prepare a search before posting it',
      blocks: [
    ...
    {
      heading: 'Define the responsibilities',
      blocks: [
        'The clearer the role, the easier it will be to evaluate candidates.',
      ],
    },
    {
      heading: 'Distinguish between essential and nice-to-have',
      blocks: [
    ...
    {
      heading: 'An engaged candidate responds faster',
      blocks: [
    ...
    {
      heading: 'Companies that communicate better lose fewer candidates',
      blocks: [
  ...
  checklist: [
    'Preparation: Role clearly defined',
    'Preparation: Responsibilities well identified',
    'Preparation: Realistic requirements',
    'Process: Roles and responsibilities defined',
    'Process: Clear selection stages',
    'Process: Shared timelines',
    'Communication: Quick responses to candidates',
    'Communication: Updates throughout the process',
    'Evaluation: Shared criteria',
    'Evaluation: Timely decisions',
    'Measurement: KPIs monitored',
    'Measurement: Continuous improvement',
  ],
  faq: [
    { q: 'What is a good time-to-hire?', a: 'It depends on the role and industry. The goal isn\'t to be the fastest, but to avoid unnecessary delays.' },
    { q: 'Does reducing time-to-hire mean lowering quality?', a: 'No. It means eliminating inefficiencies and making the process smoother.' },
    { q: 'What\'s the most common mistake?', a: 'Waiting for the perfect candidate instead of evaluating people\'s real potential.' },
    { q: 'How much does response speed matter?', a: 'A lot. The most in-demand candidates often receive multiple offers at the same time.' },
    { q: 'Do I need an ATS to speed up hiring?', a: 'It can help, but clear processes and defined responsibilities come first.' },
    { q: 'Which KPIs should I track?', a: 'At least: time-to-hire; response time; qualified applications; offer acceptance rate.' },
  ],
  signature: 'az',
};
