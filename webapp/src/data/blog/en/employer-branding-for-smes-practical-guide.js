export default {
  ...
  category: 'recruiting',
  metaTitle: 'Employer Branding for SMEs: A Practical Guide',
  metaDescription: 'Learn how to build effective employer branding, improve your company\'s appeal and start receiving more qualified job applications.',
  ...
  sections: [
    ...
    {
      heading: 'A useful formula',
      blocks: [
        'We can think of employer branding as the sum of three elements:',
      ],
    },
    { cta: { question: 'Start building your employer branding by posting your open positions.', action: 'Post your job ad', to: '/soluzioni-e-tariffe' } },
    {
      heading: 'Reputation',
      blocks: [
    ...
    {
      heading: 'Reputation can\'t be fully controlled',
      blocks: [
    ...
    {
      heading: 'Testimonials build credibility',
      blocks: [
    ...
    {
      heading: 'Every contact leaves an impression',
      blocks: [
    ...
    {
      heading: 'Abandoned social media',
      blocks: [
        'Profiles inactive for years send a negative message.',
      ],
    },
    {
      heading: 'No response to candidates',
      blocks: [
    ...
    {
      heading: 'Thinking employer branding is just communication',
      blocks: [
  ...
  checklist: [
    'Reputation: I know how my company is perceived',
    'Culture: The values we communicate match reality',
    'Leadership: Managers and team leads represent the organization positively',
    'Candidate experience: Our processes are clear and respectful',
    'Communication: I tell the story of what makes the company unique',
    'Consistency: Website, job ads and interviews convey the same messages',
  ],
  faq: [
    { q: 'Is employer branding only useful for large companies?', a: 'No. SMEs often have very appealing qualities that deserve to be highlighted.' },
    { q: 'Do you need a big budget?', a: 'Not necessarily. Many actions mainly require attention, consistency and continuity.' },
    { q: 'How long does it take to see results?', a: 'Employer branding is a medium- to long-term investment, but some improvements can produce effects within the first few months.' },
    { q: 'Do testimonials really work?', a: 'Yes. People tend to trust experiences shared by other employees more.' },
    { q: 'How can I tell if our employer branding is effective?', a: 'By looking at indicators such as: quality of applications; time to hire; retention; candidate feedback.' },
  ],
  signature: 'az',
};
